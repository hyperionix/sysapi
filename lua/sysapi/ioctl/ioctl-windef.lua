...
StringifyTableStart("DEVICE_CHARACTERISTICS", "FILE_")
...
StringifyTableStart("METHOD_CODE", "METHOD_")
...
function DEVICE_TYPE_FROM_CTL_CODE(ctlCode)
  return rshift(band(ctlCode, 0xffff0000), 16)
end
